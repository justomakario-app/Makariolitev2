...
- [ ] **Núcleo restante (construcción, reglas ya definidas — NO hecho)**: UI multi-jornada; ciclo reservado→en_proceso con "Iniciar tarea" (Fase 3/6); catálogo/stock de placas + MP de Pino con consumo y bloqueo por config faltante (Fase 4); capacidad configurable con equivalencia a sets nullable (Fase 9); estados demorado/reprogramado + mapeo configurable (Fase 10); mínimos extendidos (Fase 11); + día de fábrica y auditoría adversarial sobre todo eso.
