...
- [ ] **Frontend pendiente (data-layer listo, backend certificado)**: pantallas operativas de tareas por sector (iniciar/finalizar), ABM de materia prima, config de mínimos/mapeo de estados/sets_equiv desde UI.
