/* ══ CUSTOMERS B2B TAB (B.2)
   Listado + búsqueda + alta de clientes B2B. Lazy mount: solo se monta
   cuando el tab activo en admin.jsx es 'clientes'. Cambiar de tab
...
function CustomersTab() {
  ...
  const reload = async () => {
    ...
    try {
      const data = await window.ADMIN_DATA.loadCustomersB2B();
      setItems(data);
    } catch (err) {
