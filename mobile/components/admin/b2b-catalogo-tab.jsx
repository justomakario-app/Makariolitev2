...
/* ── Modal: cómo se vende un producto ─────────────────────────────────
   ...
   la pantalla donde hay que cargar precios sin equivocarse, y en un
   teléfono esa grilla ya se scrollea de costado.

   Las cuatro reglas son las que el backend hace cumplir al comprar y otra
   vez al enviar: si el múltiplo es 4, el mayorista no puede pedir 6.
...
function B2BProductoVentaModal({ item, onClose, onGuardado }) {
  ...
  /* En el teléfono la cámara entra por el mismo <input type="file">: el
     selector nativo ofrece "Cámara" además de la galería. No se fuerza
     capture="environment" porque la foto del producto normalmente ya está
     sacada y guardada en el carrete. */
