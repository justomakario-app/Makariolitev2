/* ══ LÍNEA PRODUCTIVA · TAREAS (ciclo reservado → en_proceso → finalizada) ══
   ...
   (Espejo mobile: padding lateral menor.)
...
(function () {
  ...
  function LineaTareasPage() {
    ...
    return (
      <div style={{ background:U.surface2, padding:'18px clamp(8px,3vw,14px) 28px', minHeight:'60vh', boxSizing:'border-box', maxWidth:'100%', overflowX:'hidden' }}>
