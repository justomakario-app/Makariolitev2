...
/* ── Tab "De fábrica" — panorama operativo de la fábrica hoy ──────────
   Vista consolidada (read-only): KPIs del día + orden por sector
   (prod_v_orden_sector) + lista de compras (prod_v_compras). Reusa LP_DATA. */
const FAB_UI = {
...
function DeFabrica() {
  ...
  return (
    <div style={{ padding:'18px 16px 32px', color:U.ink, fontSize:13 }}>
